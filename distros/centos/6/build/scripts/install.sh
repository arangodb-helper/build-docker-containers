...
yum -y install arangodb-gcc54-5.4.0 arangodb-jemalloc-devel arangodb-jemalloc-devel-static glibc-devel python-argparse openssl-devel rpm-build cmake openldap-devel.x86_64 yum-utils
