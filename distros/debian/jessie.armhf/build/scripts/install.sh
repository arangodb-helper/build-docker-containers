...
apt-get update
apt-get install -y tar wget bzip2 automake autoconf python-argparse apt-utils apt-transport-https debhelper python python-pip debhelper qemu binfmt-support qemu-user-static
